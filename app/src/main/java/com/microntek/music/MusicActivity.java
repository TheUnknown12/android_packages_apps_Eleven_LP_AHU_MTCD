...
import com.microntek.music.activities.SlidingPanelActivity;
import com.microntek.music.fragments.AlbumDetailFragment;
import com.microntek.music.fragments.ArtistDetailFragment;
import com.microntek.music.fragments.AudioPlayerFragment;
import com.microntek.music.fragments.IChildFragment;
import com.microntek.music.fragments.ISetupActionBar;
import com.microntek.music.fragments.PlaylistDetailFragment;
import com.microntek.music.fragments.RecentFragment;
import com.microntek.music.fragments.phone.MusicBrowserPhoneFragment;
import com.microntek.music.fragments.profile.LastAddedFragment;
import com.microntek.music.fragments.profile.TopTracksFragment;
import com.cyanogenmod.eleven.utils.ApolloUtils;
import com.cyanogenmod.eleven.utils.BitmapWithColors;
import com.cyanogenmod.eleven.utils.MusicUtils;
import com.cyanogenmod.eleven.utils.NavUtils;

public class MusicActivity extends SlidingPanelActivity implements
        FragmentManager.OnBackStackChangedListener {
    private static final String TAG = "MusicActivity";
    private static final String ACTION_PREFIX = MusicActivity.class.getName();
        ...
        if (mBrowsePanelActive || MusicUtils.getCurrentAlbumId() < 0) {
            ...
            new AsyncTask<Void, Void, BitmapWithColors>() {
                ...
                protected BitmapWithColors doInBackground(Void... params) {
                    ImageFetcher imageFetcher = ImageFetcher.getInstance(MusicActivity.this);
            ...
            if (resultCode == RESULT_OK) {
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        ImageFetcher imageFetcher = ApolloUtils.getImageFetcher(MusicActivity.this);
