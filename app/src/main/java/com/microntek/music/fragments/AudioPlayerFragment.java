...
*/
package com.microntek.music.fragments;
...
public class AudioPlayerFragment extends Fragment implements ServiceConnection {
    ...
    private void updateNowPlayingInfo() {
        ...
        // Set the total time
        mTotalTimeW = MusicUtils.duration();
        String totalTime = MusicUtils.makeShortTimeString(getActivity(), mTotalTimeW / 1000);
    ...
    public boolean onPopupMenuItemClick(final MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menu_audio_player_equalizer:
                // Sound effects
                NavUtils.openEffectsPanel(getActivity(), MusicActivity.EQUALIZER);
                return true;
