...
import com.microntek.music.MusicActivity;
import com.microntek.music.R;
import com.microntek.music.activities.SearchActivity;
import com.microntek.music.activities.SettingsActivity;
...
public final class NavUtils {
    ...
    public static void openArtistProfile(final Activity context, final String artistName) {
        ...
        intent.setAction(MusicActivity.ACTION_VIEW_ARTIST_DETAILS);
    ...
    public static void openAlbumProfile(final Activity context,
        ...
        // Create the intent to launch the profile activity
        final Intent intent = new Intent(context, MusicActivity.class);
        intent.setAction(MusicActivity.ACTION_VIEW_ALBUM_DETAILS);
        intent.putExtras(bundle);
        context.startActivity(intent);
    }
    ...
    public static void openSmartPlaylist(final Activity context, final Config.SmartPlaylistType type) {
        // Create the intent to launch the profile activity
        final Intent intent = new Intent(context, MusicActivity.class);
        intent.setAction(MusicActivity.ACTION_VIEW_SMART_PLAYLIST);
    ...
    public static void openPlaylist(final Activity context, final long playlistId,
        ...
        // Create the intent to launch the profile activity
        final Intent intent = new Intent(context, MusicActivity.class);
        intent.setAction(MusicActivity.ACTION_VIEW_PLAYLIST_DETAILS);
        intent.putExtras(bundle);
        context.startActivity(intent);
    }
    ...
    /**
     * Opens to {@link com.microntek.music.activities.SearchActivity}.
     * 
     * @param activity The {@link Activity} to use.
    ...
    /**
     * Opens to {@link MusicActivity}.
     * 
     * @param activity The {@link Activity} to use.
     */
    public static void goHome(final Activity activity, final int browseIndex) {
        final Intent intent = new Intent(activity, MusicActivity.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK
                | Intent.FLAG_ACTIVITY_NEW_TASK);
        intent.putExtra(MusicActivity.EXTRA_BROWSE_PAGE_IDX, browseIndex);
        activity.startActivity(intent);
    }
}
