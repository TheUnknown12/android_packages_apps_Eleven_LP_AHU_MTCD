...
import com.cyanogenmod.eleven.utils.AhuUtils;
...
/**
 * A backround {@link Service} used to keep music playing between activities
...
public class MusicPlaybackService extends Service {
    ...
    public static final String PLAY_ACTION_AHU = "com.microntek.playmusic";
    ...
    public static final String PAUSE_ACTION_AHU = "com.microntek.stopmusic";
    ...
    public static final String PREVIOUS_FORCE_ACTION_AHU = "com.microntek.lastmusic";
    /**
     * Called to go to the next track
     */
    public static final String NEXT_ACTION = "com.cyanogenmod.eleven.next";
    public static final String NEXT_ACTION_AHU = "com.microntek.nextmusic";
    ...
    public void onCreate() {
        ...
        filter.addAction(PREVIOUS_FORCE_ACTION_AHU);
    ...
    private void handleCommandIntent(Intent intent) {
        ...
        if (CMDNEXT.equals(command) || NEXT_ACTION.equals(action) || NEXT_ACTION_AHU.equals(action)) {
            gotoNext(true);
        } else if (CMDPREVIOUS.equals(command) || PREVIOUS_ACTION.equals(action)
                || PREVIOUS_FORCE_ACTION.equals(action)) {
            prev(PREVIOUS_FORCE_ACTION.equals(action));
        } else if (PREVIOUS_FORCE_ACTION_AHU.equals(action)) {
            prev(PREVIOUS_FORCE_ACTION_AHU.equals(action));

        } else if (CMDTOGGLEPAUSE.equals(command) || TOGGLEPAUSE_ACTION.equals(action) || PLAY_ACTION_AHU.equals(action)) {
            if (isPlaying()) {
                pause();
        ...
        } else if (CMDPAUSE.equals(command) || PAUSE_ACTION.equals(action) || PAUSE_ACTION_AHU.equals(action) ) {
            pause();

            mPausedByTransientLossOfFocus = false;
        } else if (CMDPLAY.equals(command) ||PLAY_ACTION_AHU.equals(action)) {
            play();
     ...
     *            otherwise.
     *  saveToHistory True to save the mPlayPos to the history
